...
var Wallet = function Wallet() {
      ...
      return _regenerator.default.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 5:
              _context4.t1 = _context4.t0.toLowerCase();
              _context4.t2 = update.selectedAddress.toLowerCase();

              if (!(_context4.t1 !== _context4.t2)) {
                _context4.next = 9;
                break;
              }
  ...
  this.enable();
  if (typeof ethereum !== 'undefined' && ethereum.publicConfigStore) ethereum.publicConfigStore.on('update', this.updateAddress);
};
