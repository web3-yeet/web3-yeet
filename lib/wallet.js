        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 5:
              ...
              if (typeof sender !== 'string') _promise.default.reject("There is no wallet access.");
              if (!web3.utils.isBN(decimalFactor)) _promise.default.reject("Could not get token data.");
              wallet = sender;
              wei = web3.utils.fromWei(web3.utils.toBN(web3.utils.toWei(amount.toString(), 'ether')).mul(decimalFactor), 'ether');
              rawTx = {
                from: wallet,
                to: erc20.address,
                value: "0",
