...
var Wallet = function Wallet() {
    ...
    return _regenerator.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            engine = _this.ledgerWithRPC(_this.publicNode).start();
            ...
            return _promise.default.race([web3ledger.eth.getAccounts(), new _promise.default(function (resolve) {
              return setTimeout(resolve, 30000, undefined);
            })]).catch(function (e) {
              throw e;
            });
  ...
  this.ledgerLogout = function () {
    if (_this.web3.currentProvider.stop) {
      // @ts-ignore
      _this.web3.currentProvider.stop(); // @ts-ignore
  ...
  this.ledgerWithRPC = function (rpcUrl) {
    ...
    var getTransport = function getTransport() {
      return typeof window !== "undefined" ? _hwTransportU2f.default.create() : Transport.create();
    };
