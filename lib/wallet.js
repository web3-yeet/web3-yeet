...
var _contract = _interopRequireDefault(require("web3/eth/contract"));
          ...
          switch (_context2.prev = _context2.next) {
            ...
            case 5:
              ...
              return _context2.abrupt("return", new _promise.default(function (resolve, reject) {
                if (!(erc20.token instanceof _contract.default)) reject("Token instance couldn't be initialised");
                if (typeof sender !== 'string') reject("There is no wallet access.");
                if (!(decimalFactor instanceof _bn.default)) reject("Could not get token data.");
                var wallet = sender;
